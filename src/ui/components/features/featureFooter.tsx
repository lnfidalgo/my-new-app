...
export default function FeatureFooter() {
  return (
    <div className="text-white mt-7 flex col-span-2 h-40 items-center justify-around border-t-2 rounded-2xl border-[#5f5ddf] bg-gradient-to-t from-[#0f0e4d]  via-[#101946] to-[#080D27]">
